...
typedef enum OverlayType {
    ...
    OVERLAY_LOWBRIDGE_SE_NW_STRAIGHT_BEGIN = 74,
    OVERLAY_LOWBRIDGE_SE_NW_STRAIGHT_END = 82,
    OVERLAY_LOWBRIDGE_SW_NE_STRAIGHT_BEGIN = 83,
    OVERLAY_LOWBRIDGE_SW_NE_STRAIGHT_END = 91,
    OVERLAY_LOWBRIDGE_SE_NW_RAMP_BEGIN = 92,
    OVERLAY_LOWBRIDGE_SE_NW_RAMP_END = 95,
    OVERLAY_LOWBRIDGE_SW_NE_RAMP_BEGIN = 96,
    OVERLAY_LOWBRIDGE_SW_NE_RAMP_END = 99,
    OVERLAY_LOWBRIDGE_SE_NW_DESTROYED = 100,
    OVERLAY_LOWBRIDGE_SW_NE_DESTROYED = 101,
