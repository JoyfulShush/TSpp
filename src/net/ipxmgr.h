...
/*******************************************************************************
 *  @brief  This is the Connection Manager for IPX network communications. It
 *          creates, manages, & orchestrates multiple IPX connections, as well
 *          as the "global" connection ("Global Channel"), which can talk to
 *          any system on the net.
 *
