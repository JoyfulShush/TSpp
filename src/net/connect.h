...
/*******************************************************************************
 *  @brief  This class represents a single "connection" with another system.
 *          It's a pure virtual base class that acts as a framework for other
 *          classes.
 *
...
public:
    ...
    /**
     *  Connection-quality stats updated by the ACK/retry logic.
     */
